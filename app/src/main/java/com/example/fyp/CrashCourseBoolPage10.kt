...
class CrashCourseBoolPage10 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_bool_page10)
        ...
        prevButton.setOnClickListener {
            val intent = Intent(this, CrashCourseBoolPage9::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right)
        }
        ...
        val anim = ProgressBarAnimation(progressBar, 70F, 77F)
        anim.duration = 1000
