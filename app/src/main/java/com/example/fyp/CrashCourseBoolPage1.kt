...
class CrashCourseBoolPage1 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_bool_page1)
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, CrashCourseBoolPage2::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
        ...
        val anim = ProgressBarAnimation(progressBar, 20F, 40F)
        anim.duration = 1000
