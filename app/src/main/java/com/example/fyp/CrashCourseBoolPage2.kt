...
class CrashCourseBoolPage2 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_bool_page2)
        ...
        prevButton.setOnClickListener {
            val intent = Intent(this, CrashCourseBoolPage1::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right)
        }
        ...
        val anim = ProgressBarAnimation(progressBar, 13F, 20F)
        anim.duration = 1000
