...
class CrashCourseBoolPage6 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_bool_page6)
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, CrashCourseBoolPage7::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
        ...
        val anim = ProgressBarAnimation(progressBar, 42F, 49F)
        anim.duration = 1000
