...
class CrashCourseKMapPage4 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_kmap_page4)
        ...
        prevButton.setOnClickListener {
            val intent = Intent(this, CrashCourseKMapPage3::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right)
        }
        ...
        val anim = ProgressBarAnimation(progressBar, 50F, 66F)
        anim.duration = 1000
