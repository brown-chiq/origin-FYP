...
class CrashCourseLogicTopic4 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crash_course_logic_topic4)
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, CrashCourseLogicTopic5::class.java)
            startActivity(intent)
            @Suppress("DEPRECATION")
        ...
        val anim = ProgressBarAnimation(progressBar, 37F, 50F)
        anim.duration = 1000
